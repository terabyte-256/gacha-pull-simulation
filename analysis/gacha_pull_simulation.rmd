...
success_rates_honkai <- success_rates$honkai %>%
...
For Honkai games (HSR, Genshin Impact, ZZZ), we can compare the character and weapon banners.
...
plot_banner_comparison(honkai_games)
```
